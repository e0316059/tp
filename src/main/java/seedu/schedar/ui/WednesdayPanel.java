 ...
 */
public class WednesdayPanel extends UiPart<Region> {
    private static final String FXML = "WednesdayList.fxml";
    ...
    /**
     * Creates a {@code WednesdayPanel} with the given {@code ObservableList}.
     */
    public WednesdayPanel(ObservableList<Task> taskList) {
        super(FXML);

        dailyListView.setItems(taskList.filtered(x->checkTaskDate(x, getDay(3))));
