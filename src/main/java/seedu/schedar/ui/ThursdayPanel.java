 ...
 */
public class ThursdayPanel extends UiPart<Region> {
    private static final String FXML = "ThursdayList.fxml";
    ...
    /**
     * Creates a {@code ThursdayPanel} with the given {@code ObservableList}.
     */
    public ThursdayPanel(ObservableList<Task> taskList) {
        super(FXML);

        dailyListView.setItems(taskList.filtered(x->checkTaskDate(x, getDay(4))));
